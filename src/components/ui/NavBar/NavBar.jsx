...
const NavBar = () => {
    ...
    return (
        <div className="bg-gray-200 fixed w-full z-10">
            <div className="navbar gap-96 mx-auto max-w-5xl flex justify-center items-center p-4">
                {/* Logo */}
                <div className="navbar-start">
                    <div className="flex items-center">
                        <img src="/logo.png" alt="Pixmatech Logo" className="h-18 w-18" />
                        <div className="ml-2 flex flex-col mt-1">
                            <a className="text-xl font-bold text-gray-800">Pixmatech</a>
                ...
                <div>
                    ...
                    {/* Desktop Menu */}
                    <div className="hidden lg:flex navbar-center mt-2">
